...
CREATE TABLE `friend` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='好友表';
...
CREATE TABLE `mark` (
  ...
  PRIMARY KEY (`mark_id`)
) ENGINE=MyISAM AUTO_INCREMENT=60 DEFAULT CHARSET=utf8 COMMENT='签到表';
...
CREATE TABLE `my_activity` (
  ...
  PRIMARY KEY (`my_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='我的活动';
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='行业表';
